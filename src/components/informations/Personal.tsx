...
function Personal(props: any) {
	...
	return (
		<div className='flex flex-col gap-2 mb-2 h-full lg:flex-row lg:h-96'>
			...
			<div className='flex flex-col w-full p-5 items-center bg-[#ebebeb] rounded-lg lg:rounded-r-none lg:rounded-bl-none sm:flex-row lg:w-2/3'>
			...
			<div className='flex flex-col gap-2 h-full w-full p-7 justify-between bg-[#313c4e] rounded-lg lg:rounded-l-none lg:rounded-br-none lg:w-1/3 '>
